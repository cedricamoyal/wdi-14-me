...
RSpec.describe ContactsController, type: :controller do
  ...
  describe "GET#index" do
      ...
      context "without params[:letter]" do
        it "should populate an array of relevant user and store it in @contacts" do
      ...
      context "without params[:letter]" do
          it "asigns all contacts to @contacts" do
  ...
  describe "GET #show" do
    ...
    it "assigns the requested contact to @contact" do
      contact = create :contact
      # We can add params to a requested
    ...
    describe "PUT #update" do
      before :each do
        ...
        context "with invalid attribute" do
            it "locates the correct contact and not change @contact's attributes" do
